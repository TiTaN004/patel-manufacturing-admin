                ...
                <div key={item.id} className="space-y-1">
                  <button
                    ...
                    className={`w-full flex items-center gap-3.5 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 relative group ${
                      isChildActive ? 'text-white' : 'hover:bg-slate-800 hover:text-white'
                    }`}
                  >
                    ...
                    <div className="pl-4 space-y-1 ml-4 border-l border-slate-700 animate-in slide-in-from-top-2 duration-200">
                      {item.children.map(child => (
                        <button
                          ...
                          className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-medium transition-all duration-200 relative group ${
                           ...
                           <td className="px-6 py-4">
                             <div className="flex flex-col items-center gap-1.5">
                                ...
                                <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-widest ${
                                  p.stockStatus === 'in_stock' ? 'bg-emerald-100 text-emerald-700' :
